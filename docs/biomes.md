...
The key here is deriving from **ScriptableObject**, **GameObject's** oft-misunderstood cousin.   This is a distinction worth its own page; see [unity root classes](unity_root_classes.md) for more details.
